...
function inflate_gzip(bs)
  ...
  local result = arraytostr(inflate.main(bs))
...
function zzlib.gunzipf(filename)
  ...
  return inflate_gzip(inflate.bitstream_init(file))
end

function zzlib.gunzip(str)
  return inflate_gzip(inflate.bitstream_init(str))
end

function zzlib.inflate(str)
  return inflate_zlib(inflate.bitstream_init(str))
end

function int2le(str,pos)
  local a,b = str:byte(pos,pos+1)
  return b*256+a
end

function int4le(str,pos)
